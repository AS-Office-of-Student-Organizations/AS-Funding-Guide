    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          <h3><MessageSquareText/>Contact Us</h3>
          <a href="mailto:avpstudentorgs@ucsd.edu"><Mail/>avpstudentorgs@ucsd.edu</a>
        ...
        <div className="footer-section">
          <h3><Pen/>Contribute</h3>
          <a href="https://github.com/AS-Office-of-Student-Organizations/AS-Funding-Guide" target="_blank" rel="noopener noreferrer">
            <Github/>Contribute to this website
          </a>
        </div>
      </div>
    </footer>
